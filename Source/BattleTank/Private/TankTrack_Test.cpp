...
// Sets default values
ATankTrack_Test::ATankTrack_Test()
{
...
ETrackSide_Test ATankTrack_Test::GetTrackSide() const
{
	return TrackSide;
}

float ATankTrack_Test::GetMaxDrivingForce() const
{
	return MaxDrivingForce;
}

float ATankTrack_Test::GetTurnFactor() const
{
	return TurnFactor;
}

TArray<ATrackWheel*> ATankTrack_Test::GetWheels() const
{
	return Wheels;
}

void ATankTrack_Test::SetThrottle(float Throttle)
{
...
void ATankTrack_Test::BeginPlay()
{
	Super::BeginPlay();
...
TArray<ATrackWheel*> ATankTrack_Test::FindAttachedWheels()
{
...
void ATankTrack_Test::GenerateTire()
{
...
void ATankTrack_Test::AnimateTire(float Delta, float Rate, UTimelineComponent* Timeline, UPrimitiveComponent* RotationalComponent)
{
...
#if WITH_EDITOR
void ATankTrack_Test::PostEditChangeProperty(FPropertyChangedEvent& PropertyChangedEvent)
{
	GenerateTire();
}

void ATankTrack_Test::PostEditChangeChainProperty(FPropertyChangedChainEvent& PropertyChangedEvent)
{
	GenerateTire();
}
#endif
