...
#include "TankTrack_Test.generated.h"

UENUM()
enum class ETrackSide_Test : uint8
{
	None,
	Right,
	Left
...
UCLASS()
class BATTLETANK_API ATankTrack_Test : public AActor
{
	GENERATED_BODY()
...
public:	
	...
	ETrackSide_Test GetTrackSide() const;
	UFUNCTION(BlueprintCallable, Category = "Setup")
...
private:
	...
	ETrackSide_Test TrackSide = ETrackSide_Test::None;
	UPROPERTY(EditDefaultsOnly, Category = "Setup")
